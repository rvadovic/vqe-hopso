...
cost_functions_backends = ['fakeAthensV2_5k_linear', 'fakeAthensV2_exact_linear', 'fakeBogotaV2_5k_linear', 'fakeBogotaV2_exact_linear', 'fakeManilaV2_5k_linear', 'fakeManilaV2_exact_linear']
cost_functions = [
...
for cost_fn in cost_functions_backends:
    rank = 12
    budget = 6000
    if backend_mitigations.__contains__(cost_fn):
        rank = 4
        budget = 2000
    cmd = [
        "mpiexec", "-n", str(rank),
